 ...
 * </p>
 * <ul>
 *   <li>{@link DataAnalysis.impl.CollectionSchemaImpl#getAttributes <em>Attributes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollectionSchemaImpl extends EObjectImpl implements CollectionSchema {
	...
	protected EClass eStaticClass() {
		return DataAnalysisPackage.Literals.COLLECTION_SCHEMA;
	}
	...
	public EList<AttributeSchema> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentEList<AttributeSchema>(AttributeSchema.class, this, DataAnalysisPackage.COLLECTION_SCHEMA__ATTRIBUTES);
		}
		return attributes;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DataAnalysisPackage.COLLECTION_SCHEMA__ATTRIBUTES:
