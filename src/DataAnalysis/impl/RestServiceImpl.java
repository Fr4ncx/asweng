 ...
 * </p>
 * <ul>
 *   <li>{@link DataAnalysis.impl.RestServiceImpl#getUser <em>User</em>}</li>
 *   <li>{@link DataAnalysis.impl.RestServiceImpl#getPwd <em>Pwd</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RestServiceImpl extends SourceImpl implements RestService {
	...
	protected EClass eStaticClass() {
		return DataAnalysisPackage.Literals.REST_SERVICE;
	}
	...
	public void setUser(String newUser) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataAnalysisPackage.REST_SERVICE__USER, oldUser, user));
	}
	...
	public void setPwd(String newPwd) {
		...
		pwd = newPwd;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataAnalysisPackage.REST_SERVICE__PWD, oldPwd, pwd));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataAnalysisPackage.REST_SERVICE__USER:
				return getUser();
			case DataAnalysisPackage.REST_SERVICE__PWD:
				return getPwd();
		}
