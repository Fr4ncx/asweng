 ...
 * </p>
 * <ul>
 *   <li>{@link DataAnalysis.impl.ExportDataImpl#getFormat <em>Format</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExportDataImpl extends TaskImpl implements ExportData {
	...
	protected EClass eStaticClass() {
		return DataAnalysisPackage.Literals.EXPORT_DATA;
	}
	...
	public void setFormat(FormatType newFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataAnalysisPackage.EXPORT_DATA__FORMAT, oldFormat, format));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataAnalysisPackage.EXPORT_DATA__FORMAT:
				return getFormat();
		}
