 ...
 * </p>
 * <ul>
 *   <li>{@link DataAnalysis.impl.DataIntegrationImpl#getSources <em>Sources</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataIntegrationImpl extends TaskImpl implements DataIntegration {
	...
	protected EClass eStaticClass() {
		return DataAnalysisPackage.Literals.DATA_INTEGRATION;
	}
	...
	public EList<Source> getSources() {
		if (sources == null) {
			sources = new EObjectContainmentEList<Source>(Source.class, this, DataAnalysisPackage.DATA_INTEGRATION__SOURCES);
		}
		return sources;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DataAnalysisPackage.DATA_INTEGRATION__SOURCES:
