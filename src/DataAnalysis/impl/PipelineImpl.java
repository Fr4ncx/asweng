 ...
 * </p>
 * <ul>
 *   <li>{@link DataAnalysis.impl.PipelineImpl#getTasks <em>Tasks</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PipelineImpl extends EObjectImpl implements Pipeline {
	...
	protected EClass eStaticClass() {
		return DataAnalysisPackage.Literals.PIPELINE;
	}
	...
	public EList<Task> getTasks() {
		if (tasks == null) {
			tasks = new EObjectContainmentEList<Task>(Task.class, this, DataAnalysisPackage.PIPELINE__TASKS);
		}
		return tasks;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DataAnalysisPackage.PIPELINE__TASKS:
